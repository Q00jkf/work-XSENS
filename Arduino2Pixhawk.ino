...
void sendMAVLink_Odometry(
  ...
  const my_data_3f &vel, const my_data_4f &qut, const my_data_3f &omg, const my_data_u4 &status){
    ...
    odom.pose_covariance[21] = 1e-6;       // roll variance
    odom.pose_covariance[28] = 1e-6;       // pitch variance
    odom.pose_covariance[35] = 1e-6;       // yaw variance
    
    odom.velocity_covariance[0]  = COV_MEAS;  // vx variance
    odom.velocity_covariance[7]  = COV_MEAS;  // vy variance
    odom.velocity_covariance[14] = COV_MEAS;  // vz variance
    odom.velocity_covariance[21] = 1e-6;      // roll rate variance
    odom.velocity_covariance[28] = 1e-6;      // pitch rate variance
    odom.velocity_covariance[35] = 1e-6;      // yaw rate variance
